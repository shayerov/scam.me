const countries = [
  ...
  },
  {
    ...
    visits: ["Feb 7, 2024 (Melbourne – Jetstar EMZQ2D JQ202 AKL→MEL Feb 7)", "Feb 2025 (Melbourne Tullamarine, Expedia Feb 12)"],
...
const stays = [
  ...
  { from:"2017-07-21", to:"2017-08-04", flag:"🇩🇰", country:"Denmark", city:"Copenhagen – The Borderland 2017 trip" },
  { from:"2017-07-22", to:"2017-08-02", flag:"🇸🇪", country:"Sweden", city:"The Borderland 2017 (quarry)" },
  ...
  { from:"2017-11-15", to:"2017-11-22", flag:"🇳🇱", country:"Netherlands", city:"Amsterdam – Dutch Decompression 2017" },
  ...
  { from:"2021-07-27", to:"2021-08-04", flag:"🇨🇭", country:"Switzerland", city:"Zurich (SBB trains Aug 3–4)" },
  { from:"2021-08-20", to:"2021-08-26", flag:"🇩🇪", country:"Germany", city:"Berlin – Kiez Burn 2021; COVID test Aug 23" },
  { from:"2021-08-27", to:"2021-08-31", flag:"🇭🇺", country:"Hungary", city:"Budapest – Bolt rides; Omio 0656382873502146 Budapest Keleti→Vienna Aug 31" },
  ...
  { from:"2023-01-19", to:"2023-02-05", flag:"🇿🇦", country:"South Africa", city:"Johannesburg – El Al SW38NB LY51 TLV→JNB Jan 19; LY52 JNB→TLV Feb 5" },
  ...
  { from:"2023-12-31", to:"2024-02-07", flag:"🇳🇿", country:"New Zealand", city:"Auckland & NZ road trip – Airbnb Auckland Dec 31 (Etihad RADO5A TLV→AUH→PVG→AKL Dec 29)" },
  { from:"2024-02-07", to:"2024-02-22", flag:"🇦🇺", country:"Australia", city:"Melbourne – Jetstar EMZQ2D JQ202 AKL→MEL Feb 7" },
  { from:"2024-02-22", to:"2024-05-06", flag:"🇳🇿", country:"New Zealand", city:"New Zealand" },
  { from:"2024-05-06", to:"2024-05-08", flag:"🇩🇪", country:"Germany", city:"Frankfurt – Qatar KXUTUF AKL→FRA via DOH May 6; to France May 8" },
  { from:"2024-05-08", to:"2024-05-16", flag:"🇫🇷", country:"France", city:"WTF event May 8–13; Normandy May 13–16" },
  ...
  { from:"2024-06-18", to:"2024-08-01", flag:"🇩🇪", country:"Germany", city:"Berlin – BA RKRRI5 BA0988 LHR→BER Brandenburg Jun 18" },
